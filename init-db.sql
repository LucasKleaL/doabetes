...
insert into main.doabetesite_produto (nome, nomeImagem) values ('Catéter', 'static/img/produto_imagem/cateter.jpg');
insert into main.doabetesite_produto (nome, nomeImagem) values ('Aplicadores', 'static/img/produto_imagem/aplicador.jpg');
insert into main.doabetesite_produto (nome, nomeImagem) values ('Reservatório', 'static/img/produto_imagem/reservatorio.jpg');
